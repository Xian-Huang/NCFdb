...
from sesame.models import Announcement, Changelog, News
...
NEWS_TOPICS = [
    ...
    ("芝麻基因组学与营养品质会议通知", "木酚素评价、基因组学和数据库使用培训"),
    ("芝麻参考基因组 v2.0 数据发布", "候选基因、基因组注释和下载文件"),
]
...
def article(title, focus):
    return (
        ...
        "光照、土壤和表型记录判断数据是否具有可比性，例如西北甘肃与华中湖北、河南材料的木酚素差异。\n\n"
