...
class NutritionData(models.Model):
    ...
    class Meta:
        db_table = "sesame_nutrition_data"
        verbose_name = "营养数据"
...
class GeneExpression(models.Model):
    ...
    class Meta:
        db_table = "sesame_gene_expression"
        verbose_name = "基因表达"
...
class GeneAssociation(models.Model):
    ...
    class Meta:
        db_table = "sesame_gene_associations"
        verbose_name = "基因关联"
        ...
        constraints = [
            models.UniqueConstraint(fields=["source_gene", "target_gene", "target_trait", "association_type"], name="sesame_unique_gene_association")
        ]
...
class EnvironmentalFactor(models.Model):
    ...
    class Meta:
        db_table = "sesame_environmental_factors"
        verbose_name = "环境因子"
...
class RegionalMapSite(models.Model):
    ...
    class Meta:
        db_table = "sesame_regional_map_sites"
...
class RegionalEnvironmentValue(models.Model):
    ...
    class Meta:
        db_table = "sesame_regional_environment_values"
...
class MolecularFingerprint(models.Model):
    ...
    class Meta:
        db_table = "sesame_molecular_fingerprints"
        verbose_name = "分子指纹"
...
class SequencingData(models.Model):
    ...
    class Meta:
        db_table = "sesame_sequencing_data"
        verbose_name = "测序数据"
...
class GermplasmResource(models.Model):
    ...
    class Meta:
        db_table = "sesame_germplasm_resources"
        verbose_name = "种质资源"
...
class GeneticDiversityAnalysis(models.Model):
    ...
    class Meta:
        db_table = "sesame_genetic_diversity_analysis"
