export const zh = {
  ...
  tools: {
    title: "分析工具",
    subtitle: "强大的生物信息学工具，助力探索芝麻基因组数据",
    blast: "BLAST搜索",
    blastDesc: "对芝麻基因组和转录组数据库进行序列相似性搜索",
    browser: "基因组浏览器",
