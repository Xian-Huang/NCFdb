export const cropConfig = {
  ...
  contactProfile: {
    name: '曹恒春',
    email: 'sesame_hsrc@163.com',
    institution: '河南省农业科学院芝麻研究中心',
    address: '河南省郑州市金水区花园路116号',
  },
  heroImage: '/hero-bg.jpg',
  pageImages: {
    news: '/api/media/news_images/sesame-high-oil-variety.png',
    events: '/api/media/news_images/sesame-consortium-meeting.png',
    data: '/api/media/news_images/sesame-production-record.png',
    tools: '/api/media/news_images/sesame-genome-v2.png',
    research: '/api/media/news_images/sesame-breeding-workshop.png',
    contact: '/api/media/news_images/sesame-consortium-meeting.png',
  },
  fallbackNewsImages: [
    '/hero-bg.jpg',
    '/api/media/news_images/sesame-high-oil-variety.png',
    '/api/media/news_images/sesame-production-record.png'
  ],
