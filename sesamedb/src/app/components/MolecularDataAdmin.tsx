...
import {
  createSesameGeneticDiversityAnalysis,
  createSesameGermplasmResource,
  createSesameMarkerLocus,
  createSesameMolecularFingerprint,
  createSesameSequencingData,
  deleteSesameGeneticDiversityAnalysis,
  deleteSesameMarkerLocus,
  deleteSesameMolecularFingerprint,
  deleteSesameSequencingData,
  fetchSesameGeneticDiversityAnalyses,
  fetchSesameGermplasmResources,
  fetchSesameMarkerLoci,
  fetchSesameMolecularFingerprints,
  fetchSesameSequencingData,
  updateSesameGeneticDiversityAnalysis,
  updateSesameGermplasmResource,
  updateSesameMarkerLocus,
  updateSesameMolecularFingerprint,
  updateSesameSequencingData,
} from "../../apis/data_apis";
...
const schemas: Schema[] = [
  {
    key: "markers",
    title: "标记位点",
    fetch: () => fetchSesameMarkerLoci({ limit: 500 }),
    create: createSesameMarkerLocus,
    update: updateSesameMarkerLocus,
    delete: deleteSesameMarkerLocus,
  ...
  },
  {
    key: "fingerprints",
    title: "分子指纹",
    fetch: () => fetchSesameMolecularFingerprints({ limit: 500 }),
    create: createSesameMolecularFingerprint,
    update: updateSesameMolecularFingerprint,
    delete: deleteSesameMolecularFingerprint,
  ...
  },
  {
    key: "germplasm",
    title: "种质资源",
    fetch: () => fetchSesameGermplasmResources({ limit: 500 }),
    create: createSesameGermplasmResource,
    update: updateSesameGermplasmResource,
  ...
  },
  {
    key: "sequencing",
    title: "测序数据",
    fetch: () => fetchSesameSequencingData({ limit: 500 }),
    create: createSesameSequencingData,
    update: updateSesameSequencingData,
    delete: deleteSesameSequencingData,
  ...
  },
  {
    key: "diversity",
    title: "遗传多样性",
    fetch: () => fetchSesameGeneticDiversityAnalyses({ limit: 500 }),
    create: createSesameGeneticDiversityAnalysis,
    update: updateSesameGeneticDiversityAnalysis,
    delete: deleteSesameGeneticDiversityAnalysis,
