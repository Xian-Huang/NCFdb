...
export function Data() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Sesame Genomic Data Repository</h1>
        <p className="text-lg text-gray-600 max-w-3xl">
          Access and download comprehensive sesame genomic datasets, including reference genomes, annotations, expression data, and breeding information
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white p-4 rounded-lg shadow border border-gray-200 text-center">
          <div className="text-2xl font-bold">35,232</div>
      ...
      <div className="space-y-6">
        ...
        {datasetsFiles.length === 0 ? (
          <div className="text-center py-12 text-gray-500">
            <Database className="h-16 w-16 mx-auto mb-4 text-gray-300" />
            <p>No datasets available yet. Check back soon!</p>
          </div>
        ) : (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div className="flex-1">
                  <h3 className="text-xl font-semibold mb-2">{dataset.file_name}</h3>
                ...
                <a href={dataset.download_url} target="_blank" rel="noopener noreferrer" download className="flex items-center px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors ml-4">
      ...
      <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-2 text-green-900">Data Usage Policy</h3>
