...
import {
  ...
  updateSesameGene,
  deleteSesameGene,
  createSesameGeneAssociation,
  updateSesameGeneAssociation,
  deleteSesameGeneAssociation,
...
const dataTypeConfig: Record<DataType, { title: string; icon: React.ElementType; fetchFn: (params?: any) => Promise<any>; createFn: (data: any) => Promise<any>; updateFn: (id: number, data: any) => Promise<any>; deleteFn: (id: number) => Promise<any> }> = {
  ...
  gene_associations: {
    ...
    icon: Dna,
    fetchFn: fetchSesameGeneAssociations,
    createFn: createSesameGeneAssociation,
    updateFn: updateSesameGeneAssociation,
    deleteFn: deleteSesameGeneAssociation,
  },
  gene_expressions: {
