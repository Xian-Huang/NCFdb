...
export function MolecularFingerprintSection() {
  ...
  useEffect(() => {
    Promise.allSettled([
      fetchSesameMarkerLoci({ limit: 500 }),
      fetchSesameMolecularFingerprints({ limit: 1000 }),
      fetchSesameGermplasmResources({ limit: 500 }),
      fetchSesameSequencingData({ limit: 500 }),
      fetchSesameGeneticDiversityAnalyses({ limit: 500 }),
