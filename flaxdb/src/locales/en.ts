export const en = {
  ...
  home: {
    ...
    varieties: "Varieties",
    varietiesDesc: "Flax variety phenotypic data, quality analysis",
  ...
  data: {
    ...
    subtitle: "Browse and download flax genome data resources",
  ...
  news: {
    title: "News & Updates",
    subtitle: "Stay updated with the latest flax genomics research",
    categories: {
      all: "All",
      research: "Research",
      breeding: "Breeding",
  ...
  events: {
    ...
    subtitle: "Academic events and technical training in flax genomics",
  ...
  tools: {
    ...
    subtitle: "Powerful bioinformatics tools for exploring flax genomic data",
    blast: "BLAST Search",
    blastDesc: "Perform sequence similarity searches against flax genome and transcriptome databases",
    ...
    variantDesc: "Browse and analyze genetic variants from flax germplasm",
    api: "API Access",
  ...
  contact: {
    title: "Contact Us",
    subtitle: "Questions about flax genomics data? We'd love to hear from you!",
    form: "Send Message",
    name: "Name",
    email: "Email",
    subject: "Subject",
