export const zh = {
  ...
  tools: {
    title: "分析工具",
    subtitle: "强大的生物信息学工具助力亚麻籽基因组数据探索",
    blast: "BLAST搜索",
    blastDesc: "对亚麻籽基因组和转录组数据库进行序列相似性搜索",
    browser: "基因组浏览器",
    ...
    variant: "变异浏览器",
    variantDesc: "浏览和分析亚麻籽种质资源中的遗传变异",
    api: "API访问",
  ...
  contact: {
    title: "联系我们",
    subtitle: "有关亚麻籽基因组数据的问题？我们期待您的来信！",
    form: "发送消息",
    name: "姓名",
    email: "邮箱",
    subject: "主题",
