...
export function MolecularFingerprintSection() {
  ...
  useEffect(() => {
    Promise.allSettled([
      fetchFlaxMarkerLoci({ limit: 500 }),
      fetchFlaxMolecularFingerprints({ limit: 1000 }),
      fetchFlaxGermplasmResources({ limit: 500 }),
      fetchFlaxSequencingData({ limit: 500 }),
      fetchFlaxGeneticDiversityAnalyses({ limit: 500 }),
