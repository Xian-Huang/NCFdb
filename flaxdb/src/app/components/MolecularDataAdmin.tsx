...
import {
  createFlaxGeneticDiversityAnalysis,
  createFlaxGermplasmResource,
  createFlaxMarkerLocus,
  createFlaxMolecularFingerprint,
  createFlaxSequencingData,
  deleteFlaxGeneticDiversityAnalysis,
  deleteFlaxMarkerLocus,
  deleteFlaxMolecularFingerprint,
  deleteFlaxSequencingData,
  fetchFlaxGeneticDiversityAnalyses,
  fetchFlaxGermplasmResources,
  fetchFlaxMarkerLoci,
  fetchFlaxMolecularFingerprints,
  fetchFlaxSequencingData,
  updateFlaxGeneticDiversityAnalysis,
  updateFlaxGermplasmResource,
  updateFlaxMarkerLocus,
  updateFlaxMolecularFingerprint,
  updateFlaxSequencingData,
} from "../../apis/data_apis";
...
const schemas: Schema[] = [
  {
    key: "markers",
    title: "标记位点",
    fetch: () => fetchFlaxMarkerLoci({ limit: 500 }),
    create: createFlaxMarkerLocus,
    update: updateFlaxMarkerLocus,
    delete: deleteFlaxMarkerLocus,
  ...
  },
  {
    key: "fingerprints",
    title: "分子指纹",
    fetch: () => fetchFlaxMolecularFingerprints({ limit: 500 }),
    create: createFlaxMolecularFingerprint,
    update: updateFlaxMolecularFingerprint,
    delete: deleteFlaxMolecularFingerprint,
  ...
  },
  {
    key: "germplasm",
    title: "种质资源",
    fetch: () => fetchFlaxGermplasmResources({ limit: 500 }),
    create: createFlaxGermplasmResource,
    update: updateFlaxGermplasmResource,
  ...
  },
  {
    key: "sequencing",
    title: "测序数据",
    fetch: () => fetchFlaxSequencingData({ limit: 500 }),
    create: createFlaxSequencingData,
    update: updateFlaxSequencingData,
    delete: deleteFlaxSequencingData,
  ...
  },
  {
    key: "diversity",
    title: "遗传多样性",
    fetch: () => fetchFlaxGeneticDiversityAnalyses({ limit: 500 }),
    create: createFlaxGeneticDiversityAnalysis,
    update: updateFlaxGeneticDiversityAnalysis,
    delete: deleteFlaxGeneticDiversityAnalysis,
