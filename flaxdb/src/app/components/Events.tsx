...
export function Events() {
  ...
  const pastEvents = [
    {
      title: "Flax and Bast Fiber Conference 2025",
          ...
          {upcomingEvents.map((event, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                ...
                <button className="mt-3 md:mt-0 md:ml-4 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm">
                  {t("events.register")}
                </button>
              </div>
            </div>
