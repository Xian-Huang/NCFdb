      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white py-2.5 rounded-lg hover:bg-blue-600 transition-colors text-sm font-medium"
            >
              {t("contact.send")}
            </button>
          </form>
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">contact@flaxdb.org</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">www.flaxdb.org</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li>• National Flax Improvement Center</li>
              <li>• International Flax Research Network</li>
            </ul>
          </div>
        </div>
      </div>
