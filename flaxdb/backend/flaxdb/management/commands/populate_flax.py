        ...
        news_data = [
            {
                ...
                'content': '<p>The Heilongjiang Academy of Agricultural Sciences has released a flax line selected for alpha-linolenic acid accumulation, lodging resistance and stable seed set in cool spring environments.</p><p>The breeding note summarizes marker-assisted selection, multi-location oil profiling and the accession records now linked in FlaxDB.</p>',
                'author': 'Dr. Li Wei',
                'category': 'research',
            ...
            },
            {
                ...
                'content': '<p>The International Flax and Bast Fiber Conference will convene in Saskatoon from August 15-18, 2026 with sessions on fiber quality, oilseed nutrition and comparative genomics.</p><p>FlaxDB curators will present the database workflow for connecting germplasm records, trial locations and genome browser tracks.</p>',
                'author': 'CSPG',
                'category': 'events',
            ...
            },
            {
                ...
                'content': '<p>The updated flax reference assembly is now available with chromosome-level scaffolds, refreshed gene models and downloadable annotation tables.</p><p>New browser tracks include gene density, repeat coverage, oil biosynthesis candidates and curated QTL intervals from recent publications.</p>',
                'author': 'Genome Team',
                'category': 'research',
