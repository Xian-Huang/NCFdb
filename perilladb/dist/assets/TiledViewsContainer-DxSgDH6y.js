const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ViewLauncher-CJ7ar4sU.js","assets/index-CtXXpiPE.js","assets/index-bO9zydRE.css","assets/index-C1tPRPQT.js"])))=>i.map(i=>d[i]);
import{R as S,ah as oi,j as O,r as j,_ as ri}from"./index-CtXXpiPE.js";import{c as ge,fa as Qe,f2 as ai,m as we,g4 as X,bH as si,aQ as di,bK as Gt,o as et,ff as li,gK as ci,T as hi,D as vi,g2 as he,bk as ct}from"./index-C1tPRPQT.js";import{u as Tt,a as pi,V as ui,D as gi,p as ht,c as mi}from"./ViewContainer-qjOoCgmI.js";import{M as bi}from"./MoreHoriz-B0zyQ-W4.js";import"./Menu-CHjkuW7b.js";/**
 * dockview-core
 * @version 5.2.0
...
.dv-watermark {
  display: flex;
  height: 100%;
}`;ro(ao);const so=ge(O.jsx("path",{d:"M3 19h18v-6H3zm0-8h18V9H3zm0-6v2h18V5z"})),lo=ge(O.jsx("path",{d:"M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m0 16H3V5h10v4h8z"})),co=we()(r=>({headerActions:{display:"flex",alignItems:"center",height:"100%"},headerButton:{padding:4,color:r.palette.primary.contrastText},headerIcon:{fontSize:16}}));function ho({containerApi:r,group:e}){const{classes:t}=co(),{addEmptyTab:i}=Tt(),n=o=>{const a=r.addGroup({referenceGroup:e,direction:o});i(a)};return O.jsx("div",{className:t.headerActions,children:O.jsx(Qe,{menuItems:[{label:"New empty tab",icon:lo,onClick:()=>{i()}},{label:"New empty split horizontal",icon:pi,onClick:()=>{n("right")}},{label:"New empty split vertical",icon:so,onClick:()=>{n("below")}}],size:"small",className:t.headerButton,onClick:()=>{e.api.setActive()},children:O.jsx(ai,{className:t.headerIcon})})})}const vo=ge([O.jsx("path",{d:"M8 8H6v7c0 1.1.9 2 2 2h9v-2H8z"},"0"),O.jsx("path",{d:"M20 3h-8c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m0 8h-8V7h8zM4 12H2v7c0 1.1.9 2 2 2h9v-2H4z"},"1")]),po=ge(O.jsx("path",{d:"M21 8H3V4h18zm0 2H3v4h18zm0 6H3v4h18z"})),uo=ge(O.jsx("path",{d:"M14.67 5v14H9.33V5zm1 14H21V5h-5.33zm-7.34 0V5H3v14z"})),go=ge(O.jsx("path",{d:"M14.67 5v6.5H9.33V5zm1 6.5H21V5h-5.33zm-1 7.5v-6.5H9.33V19zm1-6.5V19H21v-6.5zm-7.34 0H3V19h5.33zm0-1V5H3v6.5z"}));function ni(r,e){return!e||!X(e)?[]:[...e.getViewIdsForPanel(r)].map(i=>e.views.find(n=>n.id===i)).filter(i=>i!==void 0)}function pe(r,e,t="Main"){return{id:r,component:"jbrowseView",tabComponent:"jbrowseTab",title:t,params:{panelId:r,session:e}}}function It(r){return{...r,panels:Object.fromEntries(Object.entries(r.panels).map(([e,t])=>[e,{...t,params:{}}]))}}function Ot(r,e){for(const t of r.panels)t.update({params:{panelId:t.id,session:e}})}function Ie(r,e){const t=r.panels;if(t.length<=1)return;const i=t.map(n=>({id:n.id,component:"jbrowseView",tabComponent:"jbrowseTab",title:n.title,params:n.params}));for(const n of t)r.removePanel(n);for(const[n,o]of i.entries())r.addPanel({...o,position:e(n,i)})}const mo=we()(r=>({headerActions:{display:"flex",alignItems:"center",height:"100%"},headerButton:{padding:4,color:r.palette.primary.contrastText},headerIcon:{fontSize:16}}));function bo({containerApi:r,group:e}){const{classes:t}=mo(),{rearrangePanels:i}=Tt(),n=()=>{i(c=>{Ie(c,(h,u)=>h===0?void 0:{referencePanel:u[0].id,direction:"right"})})},o=()=>{i(c=>{Ie(c,(h,u)=>h===0?void 0:{referencePanel:u[0].id,direction:"below"})})},a=()=>{i(c=>{const h=c.panels;if(h.length<=1)return;const u=Math.ceil(Math.sqrt(h.length));Ie(c,(g,x)=>{if(g===0)return;const p=g%u,w=Math.floor(g/u);if(p===0){const y=(w-1)*u;return{referencePanel:x[y].id,direction:"below"}}return{referencePanel:x[g-1].id,direction:"right"}})})},s=()=>{i(c=>{Ie(c,(h,u)=>h===0?void 0:{referencePanel:u[0].id,direction:"within"})})},d=r.panels.length>1,l=r.groups.length>1;return O.jsxs("div",{className:t.headerActions,children:[d&&O.jsx(Qe,{menuItems:[{label:"Global: change layout into set of tabs",icon:vo,onClick:s},{label:"Global: tile horizontally",icon:uo,onClick:n},{label:"Global: tile vertically",icon:po,onClick:o},{label:"Global: tile grid",icon:go,onClick:a}],size:"small",className:t.headerButton,children:O.jsx(bi,{className:t.headerIcon})}),l&&O.jsx(si,{title:"Close group",children:O.jsx(di,{size:"small",onClick:()=>{for(const c of e.panels)c.api.close()},className:t.headerButton,children:O.jsx(Gt,{className:t.headerIcon})})})]})}const fo=j.lazy(()=>ri(()=>import("./ViewLauncher-CJ7ar4sU.js"),__vite__mapDeps([0,1,2,3]))),wo=we()(r=>({container:{height:"100%",overflowY:"auto",background:r.palette.background.default},viewStack:{display:"flex",flexDirection:"column"},spacer:{height:300},emptyPanel:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%"}})),_o=et(function({params:e}){const{panelId:t,session:i}=e,{classes:n}=wo();if(!i)return O.jsx("div",{className:n.container,children:"Loading..."});const o=ni(t,i);return o.length===0?O.jsx("div",{className:n.container,children:O.jsx("div",{className:n.emptyPanel,children:O.jsx(j.Suspense,{fallback:null,children:O.jsx(fo,{session:i})})})}):O.jsx("div",{className:n.container,children:O.jsxs("div",{className:n.viewStack,children:[o.map(a=>O.jsx(ui,{view:a,session:i},a.id)),O.jsx("div",{className:n.spacer})]})})}),xo=ge(O.jsx("path",{d:"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75z"})),yo=we()({tabIcons:{display:"flex",alignItems:"center",visibility:"hidden"},tabIconsVisible:{visibility:"visible"},tabIcon:{padding:2,marginLeft:2,color:"inherit"},smallIcon:{fontSize:14}});function Do({isHovered:r,onRename:e,onClose:t}){const{classes:i}=yo();return O.jsx("div",{className:`${i.tabIcons} ${r?i.tabIconsVisible:""}`,children:O.jsx(Qe,{menuItems:[{label:"Rename tab",icon:xo,onClick:e},{label:"Close tab",icon:Gt,onClick:t}],size:"small",className:i.tabIcon,stopPropagation:!0,children:O.jsx(li,{className:i.smallIcon})})})}const zo=we()(r=>({tabContainer:{display:"flex",alignItems:"center",height:"100%",padding:"0 4px",gap:4},tabTitle:{display:"flex",alignItems:"center",flex:1,overflow:"hidden",minWidth:0},tabTitleText:{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",fontSize:"0.8rem"},editInput:{fontSize:"0.8rem",padding:"2px 4px",color:"inherit",backgroundColor:r.palette.action.selected,borderRadius:r.shape.borderRadius,flex:1}}));function ko(r){r.stopPropagation(),r.preventDefault()}function Co(r,e){var t;if(r.length===0)return"Empty";if(r.length===1){const i=r[0];return i.displayName||((t=i.assemblyNames)==null?void 0:t.map(n=>{var o;return(o=e.assemblyManager.get(n))==null?void 0:o.displayName}).join(","))||"View"}return`${r.length} views`}const So=et(function({params:e,api:t}){const{panelId:i,session:n}=e,{classes:o}=zo(),[a,s]=j.useState(!1),[d,l]=j.useState(!1),[c,h]=j.useState("");if(!n)return O.jsx("div",{className:o.tabContainer,children:O.jsx("span",{className:o.tabTitleText,children:"Loading..."})});const u=ni(i,n),g=Co(u,n),x=()=>{h(t.title||g),s(!0)},p=()=>{c.trim()&&t.setTitle(c.trim()),s(!1)},w=y=>{y.key==="Enter"?p():y.key==="Escape"&&s(!1)};return O.jsx("div",{className:o.tabContainer,onMouseEnter:()=>{l(!0)},onMouseLeave:()=>{l(!1)},children:O.jsx("div",{className:o.tabTitle,children:a?O.jsx(ci,{autoFocus:!0,className:o.editInput,value:c,onChange:y=>{h(y.target.value)},onFocus:y=>{y.target.select()},onBlur:p,onKeyDown:w,onClick:ko}):O.jsxs(O.Fragment,{children:[O.jsx(hi,{className:o.tabTitleText,variant:"body2",onDoubleClick:x,children:t.title||g}),O.jsx(Do,{isHovered:d,onRename:x,onClose:()=>{t.close()}})]})})})}),Po=we()(()=>({container:{height:"100%",width:"100%",gridRow:"components"}}));function Be(r,e){if(r)return e?{referenceGroup:r,direction:e}:{referenceGroup:r}}const Ao={jbrowseView:_o},Eo={jbrowseTab:So},Mo=et(function({session:e}){const{classes:t}=Po(),i=vi(),[n,o]=j.useState(null),a=j.useRef(new Set),s=j.useRef(!1),d=j.useRef(e);d.current=e;const l=j.useCallback(b=>{if(n){s.current=!0;try{b(n)}finally{s.current=!1}}},[n]),c=j.useCallback(b=>{if(!n)return;const _=`panel-${he()}`,f=b??n.activeGroup;n.addPanel({...pe(_,e,"New Tab"),position:Be(f)}),X(e)&&e.setActivePanelId(_)},[n,e]),h=j.useCallback((b,_)=>{if(!n||!X(e))return;e.removeViewFromPanel(b);const f=`panel-${he()}`;n.addPanel({...pe(f,e,"New Tab"),position:Be(n.activeGroup,_)}),e.assignViewToPanel(f,b),e.setActivePanelId(f)},[n,e]),u=j.useCallback(b=>{h(b)},[h]),g=j.useCallback(b=>{h(b,"right")},[h]),x=j.useMemo(()=>({api:n,rearrangePanels:l,addEmptyTab:c,moveViewToNewTab:u,moveViewToSplitRight:g}),[n,l,c,u,g]),p=j.useCallback(b=>{var P,N;const _=d.current,f=ht(),G=X(_)?_.init:void 0;if(G&&X(_)){let F=function(M,R,I){var m;if(M){if(M.viewIds!==void 0){const k=`panel-${he()}`;V||(V=k);const L=R&&I?{referenceGroup:R,direction:I}:R?{referenceGroup:R}:void 0;b.addPanel({...pe(k,_,"Tab"),position:L});for(const ze of M.viewIds)X(_)&&_.assignViewToPanel(k,ze),a.current.add(ze);const K=(m=b.getPanel(k))==null?void 0:m.group;return K&&M.size!==void 0&&T.push({group:K,size:M.size}),K}if(M.children&&M.children.length>0){const k=M.direction==="horizontal"?"right":"below";let L=R;for(let K=0;K<M.children.length;K++){const ze=M.children[K],lt=F(ze,K===0?R:L,K===0?I:k);lt&&(L=lt)}return L}}};a.current.clear();let V;const T=[];if(F(G,void 0,void 0),T.length>=2&&G.direction&&T.length===((P=G.children)==null?void 0:P.length)){const M=G.direction;requestAnimationFrame(()=>{const R=T.reduce((I,m)=>I+m.size,0);if(R>0)if(M==="horizontal"){const I=b.width;if(I>0)for(const{group:m,size:k}of T){const L=Math.round(I*(k/R));m.api.setSize({width:L})}}else{const I=b.height;if(I>0)for(const{group:m,size:k}of T){const L=Math.round(I*(k/R));m.api.setSize({height:L})}}})}_.setInit(void 0),V&&(_.setActivePanelId(V),(N=b.getPanel(V))==null||N.api.setActive());return}if(X(_)){for(const V of _.panelViewAssignments.keys())_.removePanel(V);_.setDockviewLayout(void 0)}if(a.current.clear(),f&&_.views.some(V=>V.id===f.viewId)&&X(_)){const{type:V,viewId:T}=f,F=_.views.map(I=>I.id).filter(I=>I!==T);if(F.length>0){const I=`panel-${he()}`;b.addPanel(pe(I,_));for(const m of F)_.assignViewToPanel(I,m),a.current.add(m)}const M=`panel-${he()}`,R=V==="splitRight"?"right":void 0;b.addPanel({...pe(M,_,"New Tab"),position:Be(b.activeGroup,R)}),_.assignViewToPanel(M,T),a.current.add(T),_.setActivePanelId(M),mi()}else{const V=`panel-${he()}`;b.addPanel(pe(V,_)),X(_)&&_.setActivePanelId(V)}},[]),w=j.useCallback(b=>{o(b.api),b.api.onDidActivePanelChange(z=>{z!=null&&z.id&&X(d.current)&&d.current.setActivePanelId(z.id)}),b.api.onDidRemovePanel(z=>{if(!s.current&&X(d.current)){const P=d.current.getViewIdsForPanel(z.id);for(const N of P){const V=d.current.views.find(T=>T.id===N);V&&d.current.removeView(V)}d.current.removePanel(z.id)}}),b.api.onDidLayoutChange(()=>{!s.current&&X(d.current)&&d.current.setDockviewLayout(It(b.api.toJSON()))});const _=ht()!==null,f=X(d.current)?d.current:null,G=!_&&(f==null?void 0:f.dockviewLayout);if(G)try{s.current=!0,b.api.fromJSON(G),Ot(b.api,f);for(const z of f.panelViewAssignments.values())for(const P of z)a.current.add(P);if(b.api.panels.length===0)throw new Error("No panels after fromJSON restore")}catch(z){console.error("Failed to restore dockview layout:",z),p(b.api)}finally{s.current=!1}else p(b.api)},[p]);j.useEffect(()=>ct(()=>{if(!n)return;const{views:_}=e,f=new Set(_.map(z=>z.id)),G=a.current;for(const z of _)if(!G.has(z.id)&&(G.add(z.id),X(e))){let P=e.activePanelId;if(!P||!n.getPanel(P)){const N=n.panels[0];N?P=N.id:(P=`panel-${he()}`,n.addPanel(pe(P,e))),e.setActivePanelId(P)}e.assignViewToPanel(P,z.id)}for(const z of G)f.has(z)||(G.delete(z),X(e)&&e.removeViewFromPanel(z))}),[e,n]),j.useEffect(()=>!n||!X(e)?void 0:ct(()=>{const{dockviewLayout:_}=e;if(!_||s.current)return;const f=It(n.toJSON());if(JSON.stringify(f)!==JSON.stringify(_)){s.current=!0;try{n.fromJSON(_),Ot(n,d.current),a.current.clear();for(const G of e.panelViewAssignments.values())for(const z of G)a.current.add(z)}catch(G){console.error("Failed to restore dockview layout from undo:",G)}finally{s.current=!1}}}),[e,n]);const y=i.palette.mode==="dark"?"dockview-theme-dark":"dockview-theme-light";return O.jsx(gi.Provider,{value:x,children:O.jsx("div",{className:`${t.container} ${y}`,children:O.jsx(ii,{components:Ao,tabComponents:Eo,leftHeaderActionsComponent:ho,rightHeaderActionsComponent:bo,onReady:w})})})});export{Mo as default};
