export const en = {
  ...
  tools: {
    ...
    blast: "BLAST Search",
    blastDesc: "Perform sequence similarity searches against perilla databases",
    browser: "Genome Browser",
    browserDesc: "Interactive visualization of genome assemblies and annotations",
  ...
  research: {
    eyebrow: "Perilla Research Workspace",
