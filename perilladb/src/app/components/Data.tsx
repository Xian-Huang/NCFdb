...
export function Data() {
  ...
  useEffect(() => {
    fetchPerillaDownloadFiles().then((data: any[]) => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 text-center">
          <Dna className="h-6 w-6 text-purple-500 mx-auto mb-2" />
            ...
            {filteredFiles.map((dataset, index) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <a href={dataset.download_url} target="_blank" rel="noopener noreferrer" className="ml-4 px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors text-sm">
                    {t("data.download")}
                  </a>
                </div>
              </div>
