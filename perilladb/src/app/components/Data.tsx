            ...
            {filteredFiles.map((dataset, index) => (
              ...
              >
                <div className="flex h-full flex-col justify-between gap-4">
                  ...
                  <a href={dataset.id ? `/api/download/files/${dataset.id}/download/` : dataset.download_url || "#"} target="_blank" rel="noopener noreferrer" download className="inline-flex w-fit rounded-full bg-purple-600 px-4 py-2 text-sm text-white transition-colors hover:bg-purple-700">
                    {t("data.download")}
                  </a>
                </div>
              </div>
