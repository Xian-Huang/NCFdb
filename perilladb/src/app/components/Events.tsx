...
export function Events() {
  ...
  const upcomingEvents = [
    {
      title: "International Perilla Genomics Symposium 2026",
    ...
    {
      title: "Bioinformatics Workshop: Perilla Genome Analysis",
      date: "July 20, 2026",
      time: "14:00 - 17:00",
      location: "Online",
      type: "Workshop",
    ...
    {
      title: "Perilla Breeding Innovation Forum",
      date: "August 10, 2026",
      time: "10:00 - 12:00",
      location: "Online",
      type: "Webinar",
  ...
  const pastEvents = [
    {
      title: "Perilla Research Conference 2025",
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="px-2 py-0.5 bg-violet-50 text-violet-700 text-xs rounded">
                      {event.format}
                    </span>
                  </div>
                ...
                <button className="mt-3 md:mt-0 md:ml-4 px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors text-sm">
                  {t("events.register")}
                </button>
              </div>
            </div>
