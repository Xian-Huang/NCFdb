...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        news_data = [
            {
                'title': 'New High-Oil Perilla Variety Released',
                'content': '<p>The Jilin Academy of Agricultural Sciences has released a perilla breeding line combining high seed oil with improved emergence and canopy recovery under cool early-season conditions.</p><p>PerillaDB now records the associated fatty-acid profile, cold-climate trial sites and parental accession history.</p>',
                'author': 'Dr. Wang Hong',
                'category': 'research',
            ...
            {
                'title': 'International Perilla Research Symposium 2026',
                'content': '<p>The International Perilla Research Symposium will meet in Changchun from October 15-18, 2026 with sessions on aromatic leaf chemistry, seed oil nutrition and domestication genomics.</p><p>The PerillaDB team will demonstrate accession curation, metabolite tables and visualization workflows for collaborative projects.</p>',
                'author': 'JLAAS',
                'category': 'events',
                'tags': 'conference,international,perilla',
                'views': 520,
                'is_published': True,
            ...
            {
                'title': 'Perilla Genome Sequence Now Available',
                'content': '<p>The perilla reference genome release includes updated gene annotation, terpene synthase candidates, fatty-acid pathway genes and chromosome browser tracks.</p><p>Download packages now separate raw annotation, curated gene families and expression-ready feature tables.</p>',
                'author': 'Genome Team',
                'category': 'research',
        ...
        changelogs = [
            {
                'version': '1.0.0',
                'title': 'Initial Release: PerillaDB v1.0',
                'content': 'Welcome to PerillaDB! Our initial release provides access to the perilla reference genome and basic annotation data.',
        ...
        announcements = [
            {
                'title': 'Welcome to PerillaDB',
                'content': 'We are excited to launch PerillaDB - the comprehensive database for perilla genomic data and breeding resources.',
