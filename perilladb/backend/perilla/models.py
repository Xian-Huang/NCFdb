...
class DownloadFile(models.Model):
    ...
    class Meta:
        db_table = "perilla_download_files"
        verbose_name = "下载文件"
...
class GeneExpression(models.Model):
    ...
    class Meta:
        db_table = "perilla_gene_expression"
        verbose_name = "基因表达"
...
class GeneAssociation(models.Model):
    ...
    class Meta:
        db_table = "perilla_gene_associations"
        verbose_name = "基因关联"
        ...
        constraints = [
            models.UniqueConstraint(fields=["source_gene", "target_gene", "target_trait", "association_type"], name="perilla_unique_gene_association")
        ]
...
class EnvironmentalFactor(models.Model):
    ...
    class Meta:
        db_table = "perilla_environmental_factors"
        verbose_name = "环境因子"
...
class MolecularFingerprint(models.Model):
    ...
    class Meta:
        db_table = "perilla_molecular_fingerprints"
        verbose_name = "分子指纹"
...
class SequencingData(models.Model):
    ...
    class Meta:
        db_table = "perilla_sequencing_data"
        verbose_name = "测序数据"
...
class GermplasmResource(models.Model):
    ...
    class Meta:
        db_table = "perilla_germplasm_resources"
        verbose_name = "种质资源"
...
class GeneticDiversityAnalysis(models.Model):
    ...
    class Meta:
        db_table = "perilla_genetic_diversity_analysis"
...
class Announcement(models.Model):
    ...
    class Meta:
        db_table = "perilla_announcements"
        verbose_name = "动态公告"
...
class EventRegistration(models.Model):
    ...
    class Meta:
        db_table = "perilla_event_registrations"
        verbose_name = "参会意向"
