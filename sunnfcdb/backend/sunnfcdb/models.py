...
class DownloadFile(models.Model):
    ...
    @property
    def path(self):
        return os.path.join("sunnfcdb", "download_files", self.title)

    @property
    def file_url(self):
        return f"/media/sunnfcdb/download_files/{self.title}"
...
class GeneAssociation(models.Model):
    ...
    class Meta:
        db_table = "sunnfcdb_gene_associations"
        verbose_name = "基因关联"
        ...
        constraints = [
            models.UniqueConstraint(fields=["source_gene", "target_gene", "target_trait", "association_type"], name="sunnfcdb_unique_gene_association")
        ]
...
class RegionalEnvironmentValue(models.Model):
    ...
    class Meta:
        db_table = "regional_environment_values"
...
class MolecularFingerprint(models.Model):
    ...
    class Meta:
        db_table = "sunnfcdb_molecular_fingerprints"
        verbose_name = "分子指纹"
...
class SequencingData(models.Model):
    ...
    class Meta:
        db_table = "sunnfcdb_sequencing_data"
        verbose_name = "测序数据"
...
class GermplasmResource(models.Model):
    ...
    class Meta:
        db_table = "sunnfcdb_germplasm_resources"
        verbose_name = "种质资源"
...
class GeneticDiversityAnalysis(models.Model):
    ...
    class Meta:
        db_table = "sunnfcdb_genetic_diversity_analysis"
