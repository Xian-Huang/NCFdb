...
urlpatterns = [
    ...
    path('regional-map-sites/', views.RegionalMapSiteView.as_view()),
    path('regional-map-sites/<int:pk>/', views.RegionalMapSiteDetailView.as_view()),
    path('regional-environment-values/', views.RegionalEnvironmentValueView.as_view()),
    path('regional-environment-values/<int:pk>/', views.RegionalEnvironmentValueDetailView.as_view()),
