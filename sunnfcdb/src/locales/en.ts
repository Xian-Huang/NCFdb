export const en = {
  ...
  home: {
    ...
    varieties: "Varieties",
    varietiesDesc: "Sunflower variety phenotypic data, quality analysis",
  ...
  data: {
    ...
    subtitle: "Browse and download sunflower genome data resources",
    ...
    notice: {
      ...
      content: "All data is available for research and educational purposes. Please cite the appropriate data sources when using data from this database in publications."
    }
  },
  news: {
    title: "News & Updates",
    subtitle: "Stay updated with the latest sunflower genomics research",
    categories: {
      all: "All",
      research: "Research",
      breeding: "Breeding",
  ...
  events: {
    ...
    subtitle: "Academic events and technical training in sunflower genomics",
    upcoming: "Upcoming Events",
    past: "Past Events",
    register: "Register Now",
    subscribe: "Subscribe to Calendar",
    subscribeDesc: "Subscribe to calendar for the latest conference and training information"
  },
  tools: {
    title: "Analysis Tools",
    subtitle: "Powerful bioinformatics tools for exploring sunflower genomic data",
    blast: "BLAST Search",
    blastDesc: "Perform sequence similarity searches against sunflower genome and transcriptome databases",
    ...
    variantDesc: "Browse and analyze genetic variants from sunflower germplasm",
    api: "API Access",
    ...
    database: "Database",
    run: "Run BLAST",
    tutorials: "Tutorials & Documentation",
    guides: "User Guides",
    videos: "Video Tutorials",
    apiDocs: "API Documentation"
  },
  research: {
    eyebrow: "Sunflower Research Workspace",
    ...
    title: "Contact Us",
    subtitle: "Questions about sunflower genomics data? We'd love to hear from you!",
    form: "Send Message",
    name: "Name",
    email: "Email",
    subject: "Subject",
  ...
  footer: {
    copyright: "© 2026 SunNCFdb - Sunflower Nutritional Composition and Functional Characteristic Database"
  }
};
