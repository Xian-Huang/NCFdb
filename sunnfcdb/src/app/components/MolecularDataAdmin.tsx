...
import {
  createSunflowerGeneticDiversityAnalysis,
  createSunflowerGermplasmResource,
  createSunflowerMarkerLocus,
  createSunflowerMolecularFingerprint,
  createSunflowerSequencingData,
  deleteSunflowerGeneticDiversityAnalysis,
  deleteSunflowerMarkerLocus,
  deleteSunflowerMolecularFingerprint,
  deleteSunflowerSequencingData,
  ...
  updateSunflowerGeneticDiversityAnalysis,
  updateSunflowerGermplasmResource,
  updateSunflowerMarkerLocus,
  updateSunflowerMolecularFingerprint,
  updateSunflowerSequencingData,
} from "../../apis/data_apis";
...
const schemas: Schema[] = [
  {
    key: "markers",
    title: "标记位点",
    fetch: () => fetchSunflowerMarkerLoci({ limit: 500 }),
    create: createSunflowerMarkerLocus,
    update: updateSunflowerMarkerLocus,
    delete: deleteSunflowerMarkerLocus,
  ...
  },
  {
    key: "fingerprints",
    title: "分子指纹",
    fetch: () => fetchSunflowerMolecularFingerprints({ limit: 500 }),
    create: createSunflowerMolecularFingerprint,
    update: updateSunflowerMolecularFingerprint,
    delete: deleteSunflowerMolecularFingerprint,
  ...
  },
  {
    key: "germplasm",
    title: "种质资源",
    fetch: () => fetchSunflowerGermplasmResources({ limit: 500 }),
    create: createSunflowerGermplasmResource,
    update: updateSunflowerGermplasmResource,
  ...
  },
  {
    key: "sequencing",
    title: "测序数据",
    fetch: () => fetchSunflowerSequencingData({ limit: 500 }),
    create: createSunflowerSequencingData,
    update: updateSunflowerSequencingData,
    delete: deleteSunflowerSequencingData,
  ...
  },
  {
    key: "diversity",
    title: "遗传多样性",
    fetch: () => fetchSunflowerGeneticDiversityAnalyses({ limit: 500 }),
    create: createSunflowerGeneticDiversityAnalysis,
    update: updateSunflowerGeneticDiversityAnalysis,
    delete: deleteSunflowerGeneticDiversityAnalysis,
