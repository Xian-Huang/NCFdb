            ...
            {filteredFiles.map((dataset, index) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <a href={dataset.id ? `/api/download/files/${dataset.id}/download/` : dataset.download_url || "#"} target="_blank" rel="noopener noreferrer" download className="ml-4 bg-red-600 px-4 py-2 text-sm text-white transition-colors hover:bg-red-700">
                    {t("data.download")}
                  </a>
                </div>
              </div>
