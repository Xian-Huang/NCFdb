...
import {
  createSafflowerGeneticDiversityAnalysis,
  createSafflowerGermplasmResource,
  createSafflowerMarkerLocus,
  createSafflowerMolecularFingerprint,
  createSafflowerSequencingData,
  deleteSafflowerGeneticDiversityAnalysis,
  deleteSafflowerMarkerLocus,
  deleteSafflowerMolecularFingerprint,
  deleteSafflowerSequencingData,
  fetchSafflowerGeneticDiversityAnalyses,
  fetchSafflowerGermplasmResources,
  fetchSafflowerMarkerLoci,
  fetchSafflowerMolecularFingerprints,
  fetchSafflowerSequencingData,
  updateSafflowerGeneticDiversityAnalysis,
  updateSafflowerGermplasmResource,
  updateSafflowerMarkerLocus,
  updateSafflowerMolecularFingerprint,
  updateSafflowerSequencingData,
} from "../../apis/data_apis";
...
const schemas: Schema[] = [
  {
    key: "markers",
    title: "标记位点",
    fetch: () => fetchSafflowerMarkerLoci({ limit: 500 }),
    create: createSafflowerMarkerLocus,
    update: updateSafflowerMarkerLocus,
    delete: deleteSafflowerMarkerLocus,
  ...
  },
  {
    key: "fingerprints",
    title: "分子指纹",
    fetch: () => fetchSafflowerMolecularFingerprints({ limit: 500 }),
    create: createSafflowerMolecularFingerprint,
    update: updateSafflowerMolecularFingerprint,
    delete: deleteSafflowerMolecularFingerprint,
  ...
  },
  {
    key: "germplasm",
    title: "种质资源",
    fetch: () => fetchSafflowerGermplasmResources({ limit: 500 }),
    create: createSafflowerGermplasmResource,
    update: updateSafflowerGermplasmResource,
  ...
  },
  {
    key: "sequencing",
    title: "测序数据",
    fetch: () => fetchSafflowerSequencingData({ limit: 500 }),
    create: createSafflowerSequencingData,
    update: updateSafflowerSequencingData,
    delete: deleteSafflowerSequencingData,
  ...
  },
  {
    key: "diversity",
    title: "遗传多样性",
    fetch: () => fetchSafflowerGeneticDiversityAnalyses({ limit: 500 }),
    create: createSafflowerGeneticDiversityAnalysis,
    update: updateSafflowerGeneticDiversityAnalysis,
    delete: deleteSafflowerGeneticDiversityAnalysis,
