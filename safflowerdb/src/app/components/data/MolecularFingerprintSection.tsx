...
export function MolecularFingerprintSection() {
  ...
  useEffect(() => {
    Promise.allSettled([
      fetchSafflowerMarkerLoci({ limit: 500 }),
      fetchSafflowerMolecularFingerprints({ limit: 1000 }),
      fetchSafflowerGermplasmResources({ limit: 500 }),
      fetchSafflowerSequencingData({ limit: 500 }),
      fetchSafflowerGeneticDiversityAnalyses({ limit: 500 }),
