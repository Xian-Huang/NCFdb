export const zh = {
  ...
  tools: {
    title: "分析工具",
    subtitle: "强大的生物信息学工具，助力探索红花数据",
    blast: "BLAST搜索",
    blastDesc: "对红花数据库进行序列相似性搜索",
    browser: "基因组浏览器",
  ...
  research: {
    eyebrow: "Safflower Research Workspace",
    ...
    title: "联系我们",
    subtitle: "有关红花数据的问题？我们很乐意收到您的来信！",
    form: "发送消息",
    name: "姓名",
    email: "邮箱",
    subject: "主题",
