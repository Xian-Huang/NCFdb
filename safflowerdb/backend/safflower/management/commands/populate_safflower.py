        ...
        news_data = [
            {
                ...
                'content': '<p>The Gansu Academy of Agricultural Sciences has advanced a high-oil safflower line selected under dryland irrigation regimes in northwestern China.</p><p>The release record in SAFNCFDB links flower color, seed oil percentage, drought response notes and regional trial summaries for breeders screening arid-zone materials.</p>',
                'author': 'Dr. Zhang Wei',
                'category': 'research',
            ...
            },
            {
                ...
                'content': '<p>The International Safflower Congress will be held in Lanzhou from September 10-14, 2026, focusing on drought adaptation, medicinal pigments, seed oil quality and industrial uses.</p><p>SAFNCFDB will host a database clinic for participants preparing germplasm descriptors and trial metadata for public release.</p>',
                'author': 'GAAS',
                'category': 'events',
            ...
            },
            {
                ...
                'content': '<p>The safflower reference genome page now includes chromosome pseudomolecules, gene family tables and pathway candidates related to linoleic acid and carthamin biosynthesis.</p><p>Curators also added cross-links from genome regions to trait observations and downloadable annotation files.</p>',
                'author': 'Genome Team',
                'category': 'research',
