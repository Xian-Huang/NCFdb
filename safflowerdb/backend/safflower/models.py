...
class NutritionData(models.Model):
    ...
    class Meta:
        db_table = "safflower_nutrition_data"
        verbose_name = "营养数据"
...
class GeneAssociation(models.Model):
    ...
    class Meta:
        db_table = "safflower_gene_associations"
        verbose_name = "基因关联"
        ...
        constraints = [
            models.UniqueConstraint(fields=["source_gene", "target_gene", "target_trait", "association_type"], name="safflower_unique_gene_association")
        ]
...
class RegionalMapSite(models.Model):
    ...
    class Meta:
        db_table = "safflower_regional_map_sites"
...
class RegionalEnvironmentValue(models.Model):
    ...
    class Meta:
        db_table = "safflower_regional_environment_values"
...
class MarkerLocus(models.Model):
    ...
    class Meta:
        db_table = "safflower_marker_loci"
        verbose_name = "分子标记位点"
...
class MolecularFingerprint(models.Model):
    ...
    class Meta:
        db_table = "safflower_molecular_fingerprints"
        verbose_name = "分子指纹"
...
class SequencingData(models.Model):
    ...
    class Meta:
        db_table = "safflower_sequencing_data"
        verbose_name = "测序数据"
...
class GermplasmResource(models.Model):
    ...
    class Meta:
        db_table = "safflower_germplasm_resources"
        verbose_name = "种质资源"
...
class GeneticDiversityAnalysis(models.Model):
    ...
    class Meta:
        db_table = "safflower_genetic_diversity_analysis"
...
class EventRegistration(models.Model):
    ...
    class Meta:
        db_table = "safflower_event_registrations"
        verbose_name = "参会意向"
